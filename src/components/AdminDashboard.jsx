...
const {
  FiUsers, FiFileText, FiBarChart3, FiSettings, FiBell, FiSearch,
  FiPlus, FiEdit3, FiTrash2, FiEye, FiDownload, FiUpload,
  FiCalendar, FiClock, FiTrendingUp, FiTrendingDown, FiActivity,
  FiGlobe, FiShield, FiDatabase, FiMonitor, FiMail, FiMessageSquare,
  FiHeart, FiShare2, FiBookmark, FiStar, FiFilter, FiRefreshCw,
  FiMoreVertical, FiLogOut, FiUser, FiHome, FiFolder, FiImage,
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Website Activity</h3>
          ...
          <div className="h-64 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg flex items-center justify-center">
            <div className="text-center">
              <SafeIcon icon={FiActivity} className="w-12 h-12 text-gray-400 mx-auto mb-2" />
            ...
            {[
              ...
              <div key={index} className="flex items-center space-x-3">
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  ...
                  activity.type === 'comment' ? 'bg-yellow-100' : 'bg-purple-100'
                }`}>
                  <SafeIcon 
                    icon={
                    ...
                    className={`w-4 h-4 ${
                      ...
                      activity.type === 'comment' ? 'text-yellow-600' : 'text-purple-600'
                    }`} 
                  />
                </div>
            ...
            <tbody>
              {recentPosts.map((post) => (
                <tr key={post.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-700">{post.views.toLocaleString()}</td>
          ...
          <table className="min-w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="text-left py-3 px-6 font-medium text-gray-700">Post</th>
            ...
            <tbody>
              {recentPosts.map((post) => (
                <tr key={post.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-700">{post.views.toLocaleString()}</td>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-4 px-6 text-gray-700">{user.posts}</td>
      ...
      case 'settings':
        return (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600">Configure your CMS settings and preferences</p>
          </div>
        );
      default:
        return renderDashboard();
        ...
        <header className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600">Manage your content management system</p>
            </div>
            <div className="flex items-center space-x-4">
              {/* Search */}
              <div className="relative">
